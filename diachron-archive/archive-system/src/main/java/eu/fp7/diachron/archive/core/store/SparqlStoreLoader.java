 ...
 * 
 * FIXME it is not clear which metadata should be generated by the loader, so at the moment no
 * additional data is generated (in the {@link VirtuosoLoader} implementation it looks quite
 * differently). This should be cleared.
 * 
