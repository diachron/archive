/* Generated By:JavaCC: Do not edit this line. DiachronSPARQLParser11.java */
/**
...
public class DiachronSPARQLParser11 extends SPARQLParserBase implements DiachronSPARQLParser11Constants {
    ...
    public DiachronQuery getDiachronQuery() {
                return (DiachronQuery)getQuery();
        }
...
// Query only entry point
  ...
  final public void DiachronQuery() throws ParseException {
    DiachronQueryStart();
    Prologue();
    SelectQuery();
    ValuesClause();
  ...
  final public void DiachronQueryStart() throws ParseException {
    jj_consume_token(DIACHRON);
                  getDiachronQuery().setDiachronQuery() ;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NO_SCHEMA:
      jj_consume_token(NO_SCHEMA);
                  getDiachronQuery().setSchemaDisabled() ;
      break;
    default:
      jj_la1[2] = jj_gen;
      ;
...
//DIACHRON FROM DATASET
  final public void DiachronSourceEnd() throws ParseException {
          if(getDiachronQuery().isDiachronQuery())
          {
            getDiachronQuery().finalizeDiachronDictionaryQuery();
                getDiachronQuery().finalizeDiachronChangesetDictionaryQuery();
          }
  }

  final public void DiachronFinishQuery() throws ParseException {
         if(getDiachronQuery().isDiachronQuery())
            {
                  getQuery().setQueryPattern(getDiachronQuery().buildDiachronQuery());
                  //System.out.println(getQuery().serialize());
                }
  }

  final public void DiachronDatasetClause() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case DATASET:
      DatasetAtVersionGraphClause();
      break;
    case CHANGES:
      ChangesetAtVersionGraphClause();
      break;
    default:
      jj_la1[21] = jj_gen;
      jj_consume_token(-1);
  ...
  if(getDiachronQuery().isDiachronQuery())
            {
                         getDiachronQuery().isDiachronQuery();
  }
  }

  final public Node DiachronicDatasetGraphClause() throws ParseException {
                                       Node iri ;
    iri = DiachronSourceSelector();
    getDiachronQuery().addDiachronicDataset(iri) ;
    {if (true) return iri ;}
    throw new Error("Missing return statement in function");
  }

  final public Node DiachronicChangesetGraphClause() throws ParseException {
                                         Node iri ;
    iri = DiachronSourceSelector();
    getDiachronQuery().addDiachronicChangeset(iri) ;
    {if (true) return iri ;}
    throw new Error("Missing return statement in function");
  }

  final public void DatasetAtVersionGraphClause() throws ParseException {
                                      Node diri ; Node diri2 ; Node iri = null ; ArrayList<Node> list;
    jj_consume_token(DATASET);
    iri = DiachronicDatasetGraphClause();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case AT_VERSION:
    case BEFORE:
    case AFTER:
    case BETWEEN:
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case AT_VERSION:
        jj_consume_token(AT_VERSION);
        diri = DiachronSourceSelector();
                    list = new ArrayList<Node>();
                    list.add(diri);
                    getDiachronQuery().addDiachronicDataset(iri, list, "at") ;
        break;
      case BEFORE:
        ...
        diri = DiachronSourceSelector();
                    list = new ArrayList<Node>();
                    list.add(diri);
                    getDiachronQuery().addDiachronicDataset(iri, list, "before") ;
        break;
      case AFTER:
        ...
        diri = DiachronSourceSelector();
                    list = new ArrayList<Node>();
                    list.add(diri);
                    getDiachronQuery().addDiachronicDataset(iri, list, "after") ;
        break;
      case BETWEEN:
        jj_consume_token(BETWEEN);
        diri = DiachronSourceSelector();
        jj_consume_token(AND);
        diri2 = DiachronSourceSelector();
                    list = new ArrayList<Node>();
                    list.add(diri);
                    list.add(diri2);
                    getDiachronQuery().addDiachronicDataset(iri, list, "between") ;
        break;
      default:
        jj_la1[22] = jj_gen;
        jj_consume_token(-1);
  ...
  final public void ChangesetAtVersionGraphClause() throws ParseException {
                                        Node diri ; Node diri2 ; Node iri = null ; ArrayList<Node> list;
    jj_consume_token(CHANGES);
    iri = DiachronicChangesetGraphClause();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case AT_VERSION:
    case BEFORE:
    case AFTER:
    case BETWEEN:
      ...
      case AT_VERSION:
        ...
        diri = DiachronSourceSelector();
                    list = new ArrayList<Node>();
                    list.add(diri);
                    getDiachronQuery().addDiachronicChangeset(iri, list, "at") ;
        break;
      case BEFORE:
        jj_consume_token(BEFORE);
        diri = DiachronSourceSelector();
                    list = new ArrayList<Node>();
                    list.add(diri);
                    getDiachronQuery().addDiachronicChangeset(iri, list, "before") ;
        break;
      case AFTER:
        jj_consume_token(AFTER);
        diri = DiachronSourceSelector();
                    list = new ArrayList<Node>();
                    list.add(diri);
                    getDiachronQuery().addDiachronicChangeset(iri, list, "after") ;
        break;
      case BETWEEN:
        jj_consume_token(BETWEEN);
        diri = DiachronSourceSelector();
        ...
        diri2 = DiachronSourceSelector();
                    ...
                    list.add(diri);
                    list.add(diri2);
                    getDiachronQuery().addDiachronicChangeset(iri, list, "between") ;
        break;
      default:
        jj_la1[24] = jj_gen;
        jj_consume_token(-1);
  ...
  final public Node DiachronSourceSelector() throws ParseException {
                                  String n ;
    n = iri();
              {if (true) return NodeFactory.createURI(n) ;}
    throw new Error("Missing return statement in function");
  }

//DIACHRON SOURCE SELECTION ENDS HERE
//DIACHRON PATTERNS
  ...
  final public void WhereClause() throws ParseException {
    ...
    el = GroupGraphPattern();
                 if(getDiachronQuery().isDiachronQuery())
                {
                getDiachronQuery().setDiachronQueryBody((ElementGroup) el) ;
        }
        else
        {
                        getQuery().setQueryPattern((ElementGroup) el) ;
        }
     finishWherePattern() ;
  }

  final public Node DiachronSourceInPattern() throws ParseException {
    ...
    case BETWEEN:
      ...
      case BEFORE:
        ...
        v1Var = VarOrIri();
                    list = new ArrayList<Node>();
                    list.add(v1Var);
                    getDiachronQuery().addDiachronicDatasetInPattern(iriVar, list, "before") ;
        break;
      case AFTER:
        jj_consume_token(AFTER);
        v1Var = VarOrIri();
                    list = new ArrayList<Node>();
                    list.add(v1Var);
                    getDiachronQuery().addDiachronicDatasetInPattern(iriVar, list, "after") ;
        break;
      case BETWEEN:
        jj_consume_token(BETWEEN);
        v1Var = VarOrIri();
        ...
        v2Var = VarOrIri();
                    ...
                    list.add(v1Var);
                    list.add(v2Var);
                    getDiachronQuery().addDiachronicDatasetInPattern(iriVar, list, "between") ;
        break;
      default:
        jj_la1[28] = jj_gen;
        jj_consume_token(-1);
  ...
  final public Node DiachronRecordInPattern() throws ParseException {
                                   Node iriVar = null; String iriString = "";
  ...
  final public Node DiachronRecattInPattern() throws ParseException {
                                    Node iriVar = null; String iriString = "";
    jj_consume_token(RECATT);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IRIref:
    case PNAME_NS:
    case PNAME_LN:
...
// -----
  final public Element GraphPatternNotTriples() throws ParseException {
    ...
    case VALUES:
      ...
      break;
    case DATASET:
      el = DiachronDatasetPattern();
      break;
    case CHANGES:
      el = DiachronChangesPattern();
      break;
    case RECORD:
...
// ---- Definitions of each pattern element
  final public Element DiachronDatasetPattern() throws ParseException {
                                     Element el ; Node datasetIRI ;
    datasetIRI = DiachronSourceInPattern();
    el = GroupGraphPattern();
      {if (true) return getDiachronQuery().createDiachronDatasetInPatternElement(datasetIRI, el) ;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Element DiachronRecordPattern() throws ParseException {
                                    Element el ; Node recordIRI ;
    recordIRI = DiachronRecordInPattern();
    el = GroupRecordPattern(recordIRI);
      {if (true) return getDiachronQuery().createDiachronRecordInPatternElement(recordIRI, el) ;}
    throw new Error("Missing return statement in function");
  }
...
// by expanding out FunctionCall()
  ...
  public DiachronSPARQLParser11TokenManager token_source;
  ...
  public DiachronSPARQLParser11(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public DiachronSPARQLParser11(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new DiachronSPARQLParser11TokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public DiachronSPARQLParser11(java.io.Reader stream) {
  ...
  public DiachronSPARQLParser11(DiachronSPARQLParser11TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(DiachronSPARQLParser11TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
