...
import org.athena.imis.diachron.archive.lang.sparql_11.DiachronSPARQLParser11 ;
import com.hp.hpl.jena.sparql.syntax.Element ;
import com.hp.hpl.jena.sparql.syntax.Template ;

//code imported from com.hp.hpl.jena.sparql.lang.ParserSPARQL11
public class DiachronParserSPARQL11 extends SPARQLParser
{
    ...
    private static void perform(Query query, String string, Action action)
    {
        ...
        {
            Log.warn(DiachronParserSPARQL11.class, "Unexpected throwable: ",th) ;
            throw new QueryException(th.getMessage(), th) ;
        }
    }
}

//this wrapper class of DiachronSPARQLParser11 for not to touch the above code which originally used
//the class com.hp.hpl.jena.sparql.lang.sparql_11.SPARQLParser11

class SPARQLParser11 extends DiachronSPARQLParser11 {
