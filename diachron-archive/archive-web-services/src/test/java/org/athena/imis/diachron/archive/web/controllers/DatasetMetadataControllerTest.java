...
@WebAppConfiguration
public class DatasetMetadataControllerTest {
	...
	/**
	 * Test method for {@link org.athena.imis.diachron.archive.web.controllers.DatasetMetadataController#createDiachronicDatasetMetadata(javax.servlet.http.HttpServletRequest)}.
	 */
	@Test
	public final void testCreateDiachronicDatasetMetadata() throws Exception {
		String diachronicDatasetId = "testURI";
		//String jsonContent = "{\"message\":\"\",\"data\":,\"success\":true}";
		...
		//when(dataStatementMock.loadDiachronicDatasetMetadata(argCaptorInputStream.capture(), argCaptorStr.capture()));		       

		doNothing().
		doThrow(new RuntimeException()).when(dataStatementMock)
			.loadDiachronicDatasetMetadata(argCaptorInputStream.capture(), argCaptorStr.capture());
        ...
        MvcResult res = mockMvc.perform(MockMvcRequestBuilders.post("/archive/dataset/metadata")
